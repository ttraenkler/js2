...
- #3478 — External-backend source-to-native canary: real TypeScript through shared linear-memory planning
...
- #3482 — Benchmark the direct external backend against JS2 typed SSA and shared-plan IR
...
- #3508 — Advance the optional external-backend integration pin to pre-alpha 9
